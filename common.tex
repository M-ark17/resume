...
\vspace{-0.7cm}
	...
	\item Implemented channel aware scheduling schemes such as \textbf{MT, PF, TTA} and compared all schemes based on metrics such as \textbf{cell throughput, average user throughput and Jain Fairness index}.
    \end{itemize}
