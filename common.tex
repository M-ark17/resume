...
\hfill{(\textit{Jul'17 - Present})}
    \begin{itemize}
	\item Building and maintaining website of EE department, maintaining TA feedback and allotment portals.
...
\hfill{(\textit{Sep'17 - Mar'18})}
    \begin{itemize}
            \item Managed all mess related activites for a mess which catered for 250+ students with an approximate budget of 8,00,000/- per month.
