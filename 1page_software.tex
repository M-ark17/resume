...
\begin{itemize}
		...
		\item \textbf{Roles and responsibilities:} \textbf{Lead role }in building online system that made \textbf{automatic
...
interfaces} to collect data at different times from students and other sources.
		\item This system was used in the last \textbf{3} admission sessions with \textbf{success}.
	\end{itemize}
\end{itemize}
\vspace{-0.4cm}
\begin{itemize}[leftmargin=0.4cm]
