...
\item {Image Dehazing using colour attenuation prior and dark channel prior 
} \hfill{(\textit{Jul'18 - Nov'18})}\\
\vspace{-0.7cm}
...
\hfill{(\textit{Jul'17 - Present})}\\[-0.6cm]
	...
	\item Provide mail service, storage space, computing facilities and network facilities to the department.\vspace{-0.1cm}
