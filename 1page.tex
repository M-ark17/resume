...
\begin{itemize}
	\item Managed all mess activities which catered for \bm{$250+$} students with an budget of \textbf{$\approx$8,00,000/-} per month.
\end{itemize}
...
\colorbox{bl}{\makebox[\textwidth][c]{\bfseries \color{black} CO-CURRICULAR ACTIVITIES}} 
